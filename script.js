...
const REGIONS = [
  { id:"waterloo", name:"Waterloo Region", cx:110, cy:230, r:46, color:"#262E36",
    cities:[ {name:"Kitchener-Waterloo", anchor:642000, est:false}, {name:"Cambridge", anchor:671000, est:false} ] },
  { id:"halton", name:"Halton Region", cx:225, cy:250, r:44, color:"#C79A55",
  ...
  { id:"hamiltonniagara", name:"Hamilton-Niagara", cx:190, cy:345, r:44, color:"#9C7A45",
    cities:[ {name:"Hamilton", anchor:746245, est:false}, {name:"Niagara Falls / St. Catharines", anchor:620000, est:true} ] },
  { id:"peel", name:"Peel Region", cx:315, cy:225, r:44, color:"#B98D4E",
  ...
  { id:"toronto", name:"Toronto / GTA Core", cx:390, cy:245, r:42, color:"#090F15",
    cities:[ {name:"Toronto (City)", anchor:1081375, est:false}, {name:"Scarborough", anchor:984627, est:false} ] },
  { id:"york", name:"York Region", cx:370, cy:150, r:44, color:"#C29A5C",
  ...
  { id:"durham", name:"Durham Region", cx:480, cy:230, r:44, color:"#4A5058",
  ...
  { id:"simcoe", name:"Simcoe County", cx:330, cy:65, r:40, color:"#5C6570",
    cities:[ {name:"Barrie", anchor:780000, est:true} ] },
  { id:"ncr", name:"National Capital Region", cx:565, cy:120, r:40, color:"#404953",
    cities:[ {name:"Ottawa", anchor:734000, est:false}, {name:"Gatineau, QC", anchor:545000, est:true} ] },
  { id:"essex", name:"Essex County", cx:60, cy:390, r:40, color:"#454E58",
    cities:[ {name:"Windsor", anchor:565000, est:false}, {name:"LaSalle", anchor:620000, est:true} ] },
  { id:"middlesex", name:"Middlesex County", cx:180, cy:120, r:42, color:"#37404A",
...
function updateRVB(){
  ...
  for(let y=0;y<years;y++){ totalRent += r*12; r *= 1.03; }

  const down = price*0.20;
  const mtg = price - down;
  const m = monthlyPayment(mtg, rate, 25);
  const i = Math.pow(1+(rate/100)/2,2/12)-1;
  let bal = mtg; let principalPaid = 0;
  const totalMonths = Math.min(years*12, 25*12);
